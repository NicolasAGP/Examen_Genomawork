...
def ApiHomepage(request, format=None):
    return Response({
        'ubicación de restaurantes': reverse('restaurant_ubi_list', request=request, format=format),
        'inscripción de restaurant': reverse('restaurant_list', request=request, format=format),
        'Mesas': reverse('table_list', request=request, format=format),
        ...
        'orders final': reverse('order_item_list', request=request, format=format),
